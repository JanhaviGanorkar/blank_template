...
export default function Footer() {
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          <path fillRule="evenodd" d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987s11.987-5.367 11.987-11.987C24.014 5.367 18.647.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.49-3.323-1.297C4.25 14.794 3.76 13.643 3.76 12.346s.49-2.448 1.366-3.323c.875-.875 2.026-1.366 3.323-1.366s2.448.49 3.323 1.366c.875.875 1.366 2.026 1.366 3.323s-.49 2.448-1.366 3.323c-.875.875-2.026 1.366-3.323 1.366zm7.718-9.722c-.35 0-.672-.14-.905-.374-.234-.233-.374-.555-.374-.905 0-.35.14-.672.374-.905.233-.234.555-.374.905-.374.35 0 .672.14.905.374.234.233.374.555.374.905 0 .35-.14.672-.374.905-.233.234-.555.374-.905.374z" clipRule="evenodd" />
        </svg>
      )
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 mb-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <h3 className="text-xl font-bold text-gray-900">ChatApp</h3>
            </div>
            <p className="text-gray-600 mb-6 max-w-sm">
              Connect with friends, family, and colleagues through secure, fast, and reliable messaging.
            </p>
        ...
        <div className="border-t border-gray-200 pt-8 mb-8">
          <div className="max-w-md">
            ...
            <p className="text-gray-600 mb-4">Get the latest news and updates about ChatApp.</p>
        ...
        <div className="border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center space-x-6 mt-4 md:mt-0">
            <span className="text-xs text-gray-500">Made with ❤️ for better communication</span>
          </div>
        </div>
      </div>
    </footer>
