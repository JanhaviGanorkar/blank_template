  ...
  const faqs = [
    {
      ...
      answer: 'You can create an account by downloading our app and following the registration process. Just provide your email and create a secure password.'
    },
    {
      question: 'Is my data secure?',
      answer: 'Yes, we use end-to-end encryption to protect all your messages and personal data. Your privacy and security are our top priorities.'
    },
    {
      question: 'Can I use ChatApp on multiple devices?',
      answer: 'Absolutely! You can sync your account across all your devices including phones, tablets, and computers.'
    },
    {
      question: 'How do I report a bug or issue?',
      answer: 'You can report bugs through this contact form, email us directly, or use the in-app feedback feature.'
    }
  ];
